...
parser.add_argument("-y",  "--country", action="store", dest="country", required = True,
				  help="Specify Country code for CSR (2 letter)", metavar="COUNTRY", default="US")
parser.add_argument("-s",  "--state", action="store", dest="state", required = True,
				  help="Specify State code for CSR (2 letter)", metavar="STATE")
parser.add_argument("-l",  "--locality", action="store", dest="locality", required = True,
				  help="Specify City for CSR", metavar="LOCALITY")
parser.add_argument("-o",  "--org", action="store", dest="org", required = True,
				  help="Specify Organization for CSR", metavar="ORG")
parser.add_argument("-u",  "--orgunit", action="store", dest="orgunit", required = True,
